-- ============================================================================
-- SEED DE PRODUTOS E BLOCOS DE HOME PARA TURSO (SQLITE / LIBSQL)
-- ============================================================================

-- 1. BLOCOS DE HOME (HOME_BLOCKS)
...
INSERT OR IGNORE INTO home_blocks (id, title, category_id, display_order, active) VALUES
...
-- 2. SEED DE PRODUTOS (PRODUCTS)
INSERT OR REPLACE INTO products (id, name, price, image, category, slug, description, created_at) VALUES
  (
    'prod-1',
