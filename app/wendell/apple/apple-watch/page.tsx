      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 text-orange-400 text-sm font-semibold mb-8 border border-orange-500/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href={WHATSAPP_LINK} target="_blank">
                  <button className="inline-flex items-center justify-center gap-2 bg-orange-600 text-white hover:bg-orange-700 px-8 py-4 text-lg rounded-full font-bold transition-all w-full sm:w-auto">
        ...
        <section className="py-20 bg-zinc-900/30">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Serviços para Apple Watch</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={idx} className="text-center p-8 bg-zinc-900 rounded-2xl border border-zinc-800">
                    <item.icon className="w-12 h-12 mx-auto mb-6 text-orange-500" />
        ...
        <section className="py-20 bg-gradient-to-r from-orange-600 to-orange-700">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link href={WHATSAPP_LINK} target="_blank">
              <button className="inline-flex items-center gap-3 bg-white text-orange-600 px-10 py-5 rounded-full font-black text-xl hover:bg-zinc-100 transition-colors shadow-2xl">
