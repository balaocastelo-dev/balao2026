...
export default function AdminLayout({
  ...
  const tabs = [
    ...
    { name: "Reparo Apple (Home)", href: "/reparoapple", icon: Layout },
    { name: "iPhone", href: "/reparoapple/iphone", icon: Layout },
    { name: "Apple Watch", href: "/reparoapple/apple-watch", icon: Layout },
    { name: "MacBook", href: "/reparoapple/macbook", icon: Layout },
    { name: "iPad", href: "/reparoapple/ipad", icon: Layout },
    { name: "iMac", href: "/reparoapple/imac", icon: Layout },
    { name: "Mac Mini", href: "/reparoapple/mac-mini", icon: Layout },
    { name: "Agendamento", href: "/reparoapple/agendamento", icon: Layout },
