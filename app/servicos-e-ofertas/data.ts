...
export const ALL_SERVICES = [
  ...
  },
  {
    ...
    longDescription: "Instalamos a versão mais recente e estável do Windows 10 ou 11, compatível com seu hardware. Configuramos a privacidade, desativamos os rastreamentos desnecessários e removemos os programas de fábrica que deixam o computador lento. Garantimos a ativação correta com sua licença digital ou chave de produto.",
  ...
  // Hardware e Reparo Físico
  {
    ...
    longDescription: "Instalamos sua nova placa de vídeo garantindo que a fonte de alimentação suporte a carga e que o processador acompanhe o desempenho, sem gargalo. Removemos por completo os drivers antigos e instalamos os mais recentes para garantir estabilidade nos jogos.",
  ...
  },
  {
    ...
    process: ["Teste da fonte antiga", "Remoção e limpeza interna", "Instalação da nova fonte", "Organização de cabos profissional", "Teste de estabilidade"],
    time: "2 horas",
    warranty: "3 meses (Mão de obra)",
  ...
  },
  {
    ...
    process: ["Identificação do componente defeituoso", "Remoção com ar quente/ferro de solda", "Limpeza da área de solda", "Soldagem do componente novo", "Teste de continuidade e funcional"],
