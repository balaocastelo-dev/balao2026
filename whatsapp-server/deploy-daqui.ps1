...
Write-Host ""
Write-Host "Deploy feito. Esperando o WhatsApp subir..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Acesse https://www.balao.info/crm para acompanhar a conexão." -ForegroundColor Cyan
