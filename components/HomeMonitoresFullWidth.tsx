...
export default function HomeMonitoresFullWidth({ products }: HomeMonitoresFullWidthProps) {
  ...
  return (
    <section className="w-full rounded-[2.5rem] border border-slate-700/80 bg-[#111827] p-6 sm:p-8 lg:p-10 shadow-2xl relative">
      {/* Header Full-Width */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 mb-8 border-b border-slate-700/80">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs sm:text-sm font-bold text-slate-300 flex items-center gap-1.5">
              <Monitor size={16} className="text-[#E60012]" />
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-[#E60012] hover:bg-red-700 text-xs sm:text-sm font-black uppercase tracking-wider text-white transition-all shadow-lg shadow-red-950/50"
        >
      ...
      {/* Full Width Spacious Grid: 4 high-end monitors side-by-side */}
          ...
          return (
            ...
            >
              <div>
                ...
                <Link href={href} className="relative aspect-[4/3] w-full max-w-[220px] mx-auto my-4 block overflow-hidden rounded-2xl bg-white p-4 border border-slate-200 shadow-inner">
                  <Image
                ...
                <Link href={href} className="block mt-4">
                  <h3 className="text-sm sm:text-base font-extrabold text-white line-clamp-2 leading-snug group-hover:text-[#E60012] transition-colors min-h-[48px]">
                    {product.name}
                  </h3>
                </Link>
              </div>
              ...
              <div className="mt-5 pt-4 border-t border-slate-700/80 space-y-4">
                ...
                <div className="space-y-2.5">
                  <Link
                    href={href}
                    className="w-full py-4 px-5 rounded-2xl bg-[#E60012] hover:bg-red-700 text-white font-black text-xs sm:text-sm uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg shadow-red-950/50 transition-all active:scale-95"
                  >
